...
<body>
    ...
    <script type="text/javascript">
        $('.truyennoibat').change(function() {
           ...
           if (truyennoibat==0) {
            var thongbao = 'Thay đổi truyện mới thành công';
           } else if(truyennoibat==1){
            var thongbao = 'Thay đổi truyện nổi bật thành công';
           }else{
            var thongbao = 'Thay đổi truyện xem nhiều thành công';
           }
           $.ajax({
